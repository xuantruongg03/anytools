                ...
                <div className='space-y-4'>
                    ...
                    <div>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <button onClick={() => copyToClipboard(hex, "HEX")} className='px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium'>
                                {t.common.copy}
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <button onClick={() => copyToClipboard(`rgb(${rgb.r}, ${rgb.g}, ${rgb.b})`, "RGB")} className='px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium'>
                                {t.common.copy}
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <button onClick={() => copyToClipboard(`hsl(${hsl.h}, ${hsl.s}%, ${hsl.l}%)`, "HSL")} className='px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium'>
                                {t.common.copy}
                            </button>
                        </div>
                    </div>

            ...
            {activeTab === "hash" && (
                <div className='space-y-6'>
                    <div>
                        ...
                        <select value={selectedAlgorithm} onChange={(e) => setSelectedAlgorithm(e.target.value as "sha1" | "sha256" | "sha512")} className='w-full p-3 border rounded-lg bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500'>
                    ...
                    {hashes[selectedAlgorithm] && (
                        <div className='p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg'>
                            <div className='flex justify-between items-center mb-2'>
                                ...
                                <button onClick={() => copyToClipboard(hashes[selectedAlgorithm], selectedAlgorithm.toUpperCase())} className='text-sm px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors'>
                                    {t.common.copy}
                                </button>
                            </div>
            ...
            {activeTab === "encrypt" && (
                <div className='space-y-6'>
                    ...
                    <div>
                        ...
                        <select value={encryptionAlgorithm} onChange={(e) => setEncryptionAlgorithm(e.target.value as "AES-128" | "AES-192" | "AES-256")} className='w-full p-3 border rounded-lg bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500'>
                    ...
                    <div className='grid lg:grid-cols-2 gap-6'>
                        <div className='space-y-4'>
                            ...
                            <div className='flex gap-3'>
                                <button onClick={encryptText} className='flex-1 px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium'>
                                    {t.tools.hashGenerator.encryptText}
                                </button>
                                <button onClick={decryptText} className='flex-1 px-4 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium'>
                        ...
                        <div>
                            ...
                            {output && (
                                <button onClick={() => copyToClipboard(output, locale === "en" ? "result" : "kết quả")} className='mt-3 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium'>
                                    {t.common.copy}
                                </button>
                            )}
                        </div>

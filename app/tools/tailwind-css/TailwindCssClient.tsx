    ...
    return (
        <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-12'>
            ...
            <div className='flex gap-3 mb-6'>
                ...
                <button onClick={handleClear} className='px-6 py-3 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-semibold rounded-lg transition-colors'>
                    {t.common.clear}
                </button>
            </div>
            ...
            {output && (
                <div>
                    <div className='flex justify-between items-center mb-2'>
                        ...
                        <button onClick={handleCopy} className='px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2'>
                            {copied ? (
                                <>

            ...
            <div>
                ...
                {output && (
                    <div className='mt-4 flex gap-2'>
                        <button onClick={copyToClipboard} className='px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors'>
                            {t.common.copy}
                        </button>

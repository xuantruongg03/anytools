...
type SpeechToTextContentProps = {
    locale: "en" | "vi";
};

export default function SpeechToTextContent({ locale }: SpeechToTextContentProps) {
            ...
            <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6'>
                ...
                <div className='grid md:grid-cols-2 gap-4'>
                    <div className='flex gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg'>
                        ...
                        <div>
                            <h3 className='font-semibold text-gray-900 dark:text-white mb-1'>File Upload</h3>
                            <p className='text-sm text-gray-600 dark:text-gray-400'>Upload audio files (MP3, WAV, M4A, OGG) up to 25MB</p>
                        </div>
                    </div>
                    <div className='flex gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg'>
                        <span className='text-2xl'>⚡</span>
                        <div>
                            <h3 className='font-semibold text-gray-900 dark:text-white mb-1'>Fast & Accurate</h3>
                            <p className='text-sm text-gray-600 dark:text-gray-400'>Quick transcription with high accuracy</p>
                        </div>
                    </div>
                    <div className='flex gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg'>
                        <span className='text-2xl'>🌍</span>
                        <div>
                            <h3 className='font-semibold text-gray-900 dark:text-white mb-1'>Multiple Languages</h3>
                            <p className='text-sm text-gray-600 dark:text-gray-400'>Supports automatic language detection</p>
                        </div>
                    </div>
                    <div className='flex gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg'>
                        <span className='text-2xl'>🔒</span>
                        <div>
                            ...
                            <p className='text-sm text-gray-600 dark:text-gray-400'>Your audio is not stored on our servers</p>
                        </div>
                    </div>
                </div>
            </div>

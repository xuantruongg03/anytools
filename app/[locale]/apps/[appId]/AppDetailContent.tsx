        ...
        <div className='max-w-4xl mx-auto'>
            ...
            <div className='bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 mb-8'>
                ...
                <div className='flex flex-wrap gap-4'>
                    ...
                    {app.androidUrl && (
                        <button onClick={() => handleRedirect(app.androidUrl!)} className='inline-flex items-center gap-3 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-xl transition-colors shadow-lg hover:shadow-xl cursor-pointer'>
                            <svg className='w-6 h-6' viewBox='0 0 24 24' fill='currentColor'>
                                <path d='M17.523 15.3414c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.551 0 .9993.4482.9993.9993.0001.5511-.4482.9997-.9993.9997m-11.046 0c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4482.9993.9993 0 .5511-.4482.9997-.9993.9997m11.4045-6.02l1.9973-3.4592a.416.416 0 00-.1521-.5676.416.416 0 00-.5676.1521l-2.0223 3.503C15.5902 8.4111 13.8533 8.083 12 8.083c-1.8533 0-3.5902.3281-5.1367.8667L4.841 5.4467a.4161.4161 0 00-.5677-.1521.4157.4157 0 00-.1521.5676l1.9973 3.4592C2.6889 11.1867.3432 14.6589 0 18.761h24c-.3432-4.1021-2.6889-7.5743-6.1185-9.4396' />
                            </svg>
                            {t.downloadFor} Android
                        </button>
                    )}
                </div>
            </div>
            ...
            <div className='bg-linear-to-r from-blue-600 to-purple-600 rounded-2xl shadow-lg p-8 text-center text-white'>
                ...
                <div className='flex flex-wrap justify-center gap-4'>
                    ...
                    {app.androidUrl && (
                        <button onClick={() => handleRedirect(app.androidUrl!)} className='inline-flex items-center gap-2 px-6 py-3 bg-white text-emerald-600 font-medium rounded-xl hover:bg-gray-100 transition-colors cursor-pointer'>
                            <svg className='w-5 h-5' viewBox='0 0 24 24' fill='currentColor'>
                                <path d='M17.523 15.3414c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.551 0 .9993.4482.9993.9993.0001.5511-.4482.9997-.9993.9997m-11.046 0c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4482.9993.9993 0 .5511-.4482.9997-.9993.9997m11.4045-6.02l1.9973-3.4592a.416.416 0 00-.1521-.5676.416.416 0 00-.5676.1521l-2.0223 3.503C15.5902 8.4111 13.8533 8.083 12 8.083c-1.8533 0-3.5902.3281-5.1367.8667L4.841 5.4467a.4161.4161 0 00-.5677-.1521.4157.4157 0 00-.1521.5676l1.9973 3.4592C2.6889 11.1867.3432 14.6589 0 18.761h24c-.3432-4.1021-2.6889-7.5743-6.1185-9.4396' />
                            </svg>
                            Android

    ...
    return (
        <article className='bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 flex flex-col h-full'>
            ...
            <div className='flex flex-wrap gap-2 pt-4 border-t border-gray-100 dark:border-gray-700'>
                ...
                {app.androidUrl && (
                    <button onClick={() => handleRedirect(app.androidUrl!)} className='inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-300 rounded-lg hover:bg-emerald-200 dark:hover:bg-emerald-900/50 transition-colors cursor-pointer' title={t.android}>
                        <svg className='w-4 h-4' viewBox='0 0 24 24' fill='currentColor'>

...
export const toolsConfig: ToolCategory[] = [
    {
        ...
        tools: [
            ...
            { href: "/tools/chart-generator", icon: "📊", key: "chartGenerator", updatedAt: "2026-09-23" },
            ...
            { href: "/tools/url-parser", icon: "🔗", key: "urlParser", updatedAt: "2026-09-23" },
            { href: "/tools/uuid-generator", icon: "🆔", key: "uuidGenerator", updatedAt: "2026-07-05" },
            { href: "/tools/yaml-json-converter", icon: "🔄", key: "yamlJsonConverter", updatedAt: "2026-09-23" },
        ],
    },
    {
        key: "design",
        icon: "🎨",
        tools: [
            { href: "/tools/aspect-ratio-calculator", icon: "📐", key: "aspectRatioCalculator", updatedAt: "2026-09-23" },
            { href: "/tools/box-shadow-generator", icon: "✨", key: "boxShadowGenerator", updatedAt: "2026-09-02" },
            { href: "/tools/clip-path-generator", icon: "✂️", key: "clipPathGenerator", updatedAt: "2026-09-23" },
            ...
            { href: "/tools/glassmorphism-generator", icon: "🪟", key: "glassmorphismGenerator", updatedAt: "2026-09-23" },
            ...
            { href: "/tools/neumorphism-generator", icon: "🫧", key: "neumorphismGenerator", updatedAt: "2026-09-23" },
    ...
    },
    {
        ...
        tools: [
            ...
            { href: "/tools/text-fancy-font", icon: "✨", key: "textFancyFont", updatedAt: "2026-09-23" },
    ...
    },
    {
        ...
        tools: [
            ...
            { href: "/tools/password-strength-checker", icon: "🛡️", key: "passwordStrengthChecker", updatedAt: "2026-09-23" },
    ...
    },
    {
        ...
        icon: "⚡",
        tools: [
            { href: "/tools/ambient-noise-generator", icon: "🎧", key: "ambientNoiseGenerator", updatedAt: "2026-09-23" },
            { href: "/tools/auto-bing-search", icon: "🔍", key: "autoBingSearch", updatedAt: "2026-09-21" },
            { href: "/tools/barcode-generator", icon: "📊", key: "barcodeGenerator", updatedAt: "2026-09-23" },
            { href: "/tools/bmi-calculator", icon: "⚖️", key: "bmiCalculator", updatedAt: "2026-09-23" },
            { href: "/tools/countdown", icon: "⏱️", key: "countdown", updatedAt: "2026-08-20" },
            { href: "/tools/date-calculator", icon: "📅", key: "dateCalculator", updatedAt: "2026-09-23" },
            { href: "/tools/event-reminder", icon: "📅", key: "eventReminder", updatedAt: "2026-08-10" },
            { href: "/tools/invoice-generator", icon: "🧾", key: "invoiceGenerator", updatedAt: "2026-09-23" },
            ...
            { href: "/tools/social-post-generator", icon: "📱", key: "socialPostGenerator", updatedAt: "2026-09-23" },
            ...
            { href: "/tools/unit-converter", icon: "🔄", key: "unitConverter", updatedAt: "2026-09-23" },
    ...
    },
    {
        ...
        tools: [
            ...
            { href: "/tools/image-watermark", icon: "💧", key: "imageWatermark", updatedAt: "2026-09-23" },
            ...
            { href: "/tools/screen-tester", icon: "🖥️", key: "screenTester", updatedAt: "2026-09-23" },

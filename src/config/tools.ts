...
export const toolsConfig: ToolCategory[] = [
    {
        ...
        tools: [
            ...
            { href: "/tools/chmod-calculator", icon: "🛡️", key: "chmodCalculator" },
            ...
            { href: "/tools/json-to-types", icon: "🏷️", key: "jsonToTypes" },
    ...
    },
    {
        ...
        icon: "🎨",
        tools: [
            { href: "/tools/box-shadow-generator", icon: "✨", key: "boxShadowGenerator" },
    ...
    },
    {
        ...
        tools: [
            ...
            { href: "/tools/word-counter", icon: "📊", key: "wordCounter" },
        ],
    },
    {
        key: "security",

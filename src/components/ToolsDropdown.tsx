...
export function ToolsDropdown() {
    ...
    return (
        <div ref={dropdownRef} className='relative' onMouseEnter={handleMainMouseEnter} onMouseLeave={handleMainMouseLeave}>
            {/* Trigger Button */}
            <button onClick={handleButtonClick} className='flex items-center gap-1 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:cursor-pointer transition-colors px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 font-medium'>

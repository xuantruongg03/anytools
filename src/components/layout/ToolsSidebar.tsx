                            ...
                            <div key={category.key} className='space-y-1'>
                                ...
                                <button
                                    ...
                                    className={`
                                        ...
                                        ${hasActiveTool ? "bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400" : "hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300"}
                                    `}
                                >
